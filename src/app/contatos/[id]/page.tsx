    ...
    <main className="mx-auto flex w-full max-w-[1600px] flex-1 flex-col gap-5 px-5 py-6 lg:gap-8 lg:px-8 lg:py-8">
      ...
      <SectionCard title="Briefing do backstaff">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row">
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-2xl border border-gold/40 bg-gold/10 py-3 text-sm font-semibold text-gold active:scale-[0.99] transition-transform disabled:opacity-60 ${brief ? '' : 'w-full'}`}
          >
            <Sparkles size={16} />
      ...
      {clientWhatsAppHref && (
        <a
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl border border-success/40 bg-success/15 py-3.5 text-sm font-semibold text-success active:scale-[0.99]"
        >
