...
/** Botão compacto no tom do painel (Agenda / Visão) — solid ou outline. */
export function PanelButton({
  ...
  const base =
    'inline-flex items-center justify-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium transition-colors disabled:opacity-50'
  const styles =
    variant === 'solid'
      ? 'bg-foreground text-background hover:opacity-90'
      : 'border border-border text-foreground/90 hover:bg-card'
  return (
