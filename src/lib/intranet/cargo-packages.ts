...
export const CARGO_PACKAGES: readonly CargoPackage[] = [
  ...
  },
  {
    ...
    label: 'Recepção',
    alias: 'Recepção',
    summary: 'Agenda e contatos da unidade (recepção no dia a dia).',
  ...
  },
  {
    ...
    label: 'Pós-venda',
    alias: 'Pós-venda',
    summary: 'Contatos e agenda para retorno e reativação.',
  ...
  },
  {
    ...
    alias: 'Profissional',
    summary: 'Home, agenda, contatos e meu faturamento — só os dele.',
